...
<body>
    ...
    <header>
        <h1 id="page_title">Admin Section</h1>
    ...
    <menu>
        ...
        echo'<li><a href="./create-voucher.php">Create Voucher</a></li>';
        echo'<li><a href="./statistics.php">Statistics</a></li>';    
        echo'<li><a href="./manage-categories.php">Manage Categories</a></li>';
        echo'<li><a href="./manage-roles.php">Manage Roles</a></li>';
        echo'<li><a href="./logs.php">System Log</a></li>';
        echo'<li><a href="./unlock.php">Locked Users</a></li>';
    ...
    <div id="login">
        ...
        <div class="field">
            ...
            <?php echo'Welcome '.$_SESSION['username'].' you are on the Administration Section !' ?>
